...
HD_PWD='D:/PDF/course/UCB/eecs151/fpga_labs_sp20/lab2/3bit_behavioral/3bit_behavioral.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log z1top_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source z1top_adder.tcl
