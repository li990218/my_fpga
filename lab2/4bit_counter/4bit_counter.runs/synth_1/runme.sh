...
HD_PWD='D:/PDF/course/UCB/eecs151/fpga_labs_sp20/lab2/4bit_counter/4bit_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log z1top_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source z1top_counter.tcl
