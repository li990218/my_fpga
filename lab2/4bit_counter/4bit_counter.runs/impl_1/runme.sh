...
HD_PWD='D:/PDF/course/UCB/eecs151/fpga_labs_sp20/lab2/4bit_counter/4bit_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log z1top_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source z1top_counter.tcl -notrace
